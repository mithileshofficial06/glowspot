          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-6 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] backdrop-blur-sm border border-white/[0.06]">
                ...
                <span className="text-xs font-medium text-neon-gold/80 tracking-wide">
              ...
              <div className="flex flex-wrap gap-5 pt-2">
                {[
                  { icon: Shield, label: 'Photos never stored', color: 'text-emerald-glow' },
                  { icon: Zap, label: 'Results in seconds', color: 'text-neon-gold' },
                  { icon: Star, label: '100% personalized', color: 'text-neon-amber' },
                ].map((item, i) => {
            ...
            <div className={`hidden lg:block transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              <div className="relative">
                <div className="relative bg-white/[0.02] backdrop-blur-md rounded-3xl border border-white/[0.05] p-6 overflow-hidden">
                  <div className="absolute top-0 right-0 w-40 h-40 bg-neon-gold/[0.04] rounded-full blur-[60px]" />
                  <div className="absolute bottom-0 left-0 w-32 h-32 bg-emerald-glow/[0.03] rounded-full blur-[50px]" />

                  <div className="relative z-10 space-y-4">
                    <div className="flex items-center gap-3 mb-5">
                      <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-neon-gold to-emerald-glow flex items-center justify-center shadow-glow">
                    ...
                    {[
                      ...
                      { icon: Palette, label: 'Skin Tone Analysis', desc: 'Undertones & color matching', color: 'from-neon-gold/15 to-neon-amber/15', iconColor: 'text-neon-gold' },
                      { icon: Scissors, label: 'Personalized Styles', desc: 'Hairstyles, grooming & colors', color: 'from-emerald-glow/10 to-green-500/10', iconColor: 'text-emerald-glow' },
                      ...
                      return (
                        <div
                          key={i}
                          className={`flex items-center gap-3.5 p-3 rounded-2xl bg-white/[0.02] border border-white/[0.04] hover:border-neon-gold/10 hover:bg-white/[0.03] transition-all duration-500 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}
                        ...
                        >
                          ...
                          <div className="w-2 h-2 rounded-full bg-emerald-glow/50 animate-glow-pulse shrink-0" />
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="absolute -bottom-4 -left-4 bg-noir-100/80 backdrop-blur-md rounded-2xl border border-white/[0.06] px-4 py-3 animate-bounce-gentle shadow-glow">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-neon-gold to-neon-amber flex items-center justify-center">
                      <Camera className="w-4 h-4 text-black" />
                    </div>
                    <div>
                      <p className="text-neon-gold text-[11px] font-bold font-display">90B Vision</p>
